...
* Repeat you analysis. This time click Resample Tree. How did this change the tree? Note the numbers on each node, which are a measure of the confidence that the decendents of that node share this common ancestor.
