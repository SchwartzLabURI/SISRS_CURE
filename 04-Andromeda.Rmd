...
In this case you need the argument that is the "path" to the folder.
...
Now go back to the folder containing your current folder.

* Type `cd ..`, which will take you one level up in the folder hierarchy.
