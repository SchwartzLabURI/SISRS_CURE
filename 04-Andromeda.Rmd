...
* Follow the directions for students to [obtain an account](https://docs.unity.uri.edu/documentation/getting-access/){:target="_blank"} on URI's High Performance Computing Cluster (Unity).
...
* On the [main Unity page](https://unity.uri.edu/){:target="_blank"} select OpenOnDemand
...
Following these guidelines you should use `/work` for running your analyses and `/project` for storage.
