...
3. If you haven't used RStudio before learn a little bit here
4. Make a new project to work on this research project
5. Use the Upload button (lower right) to upload the file of information you obtained from ENA
6. Click the Terminal tab and type
