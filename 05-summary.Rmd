...
`mkdir` you need `mkdir results` or `mkdir test` or some other folder name.

Now that you have a new folder open it up.
You change the directory using the `cd` command.
Again, this command takes an argument so you'll type `cd results` or `cd test` depending on what you named your folder.
