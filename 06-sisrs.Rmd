...
* To see the software we will use to analyze your data go to https://github.com/SchwartzLabURI/SISRS/tree/unity
* On the command line enter `git clone -b unity https://github.com/SchwartzLabURI/SISRS.git`
...
* Change all the lines marked `CHANGE` to be relevant to your work. Use the path to you scratch folder for your output
