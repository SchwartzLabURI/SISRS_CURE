...
When you log in to Bluewaves you are on the "head node".
...
Instead of running the script with the `bash` command you will submit a job as `sbatch slurm_submissions/1_submit.slurm`.
