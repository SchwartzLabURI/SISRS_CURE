...
First figure out the complete path of your file using `pwd` while in the folder containing your alignment.
...
* type `scp username@ssh3.hac.uri.edu:path/filename .` (replacing username with your username, path with the path to your scripts or slurm_submissions folder, and filename with the name of the output from raxml, which should start with RAxML_bipartitions - list the files in the scripts or slurm_submissions folders as needed to find your path and file)
