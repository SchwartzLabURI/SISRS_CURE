...
* Change the email address and add the necessary file information.
* Submit the script as a slurm job.
* Repeat for different datasets with different amounts of missing data.
...
See Transfering Data on [URI's HPC Instructions](https://web.uri.edu/hpc-research-computing/using-andromeda/). 
...
You can calculate SCF support by editing the `runSCF.sh` script and inputing your tree and your alignment.
